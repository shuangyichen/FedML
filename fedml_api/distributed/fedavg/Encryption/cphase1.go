...
func genShamirShareString_robust(shamirShare []uint64, numPeers int, logDegree uint64, scale float64,resiliency float64)(shamirSharePointer uintptr){
...
func genShamirShares(numPeers int, logDegree uint64, scale float64, resiliency float64)(SSPoniter uintptr, collectiveKeyShairPointer uintptr){
	var ringPrime uint64 = 0x10000000001d0001
	var ringPrimeP uint64 = 0xfffffffffffc001
    k := int(float64(numPeers) * (1 - resiliency))
	if k == 0 {
...
func genCollectiveKeyShare_not_robust(numPeers int, logDegree uint64, scale float64, resiliency float64)(PK_pointer uintptr, SS uintptr){
    var ringPrime uint64 = 0x10000000001d0001
    var ringPrimeP uint64 = 0xfffffffffffc001
    k := int(float64(numPeers) * (1 - resiliency))
    if k == 0 {
