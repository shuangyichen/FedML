...
extern char* decrypt(GoString client_chosen, GoString tsk_string, GoString pcksShareString, GoString encResultStr, GoUint64 logDegree, GoFloat64 scale, GoInt inputLength, GoInt numPeers);
