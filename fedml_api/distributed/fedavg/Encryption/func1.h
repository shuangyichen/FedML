...
extern GoUintptr genSKforNewUser(GoInt k, GoUint64 logDegree, GoSlice shareList);
extern GoUintptr genShamirsharesforUser(GoSlice shamirShare, GoInt numPeers, GoUint64 logDegree);
...
extern GoUintptr genShareforNewUser(GoInt numPeers, GoInt k, GoUint64 logDegree, GoSlice shamirShare, GoSlice reconstruction_coeff, GoInt user_id);
