...
def FedML_FedAvg_distributed(process_id, worker_number, device, comm, model, param_num, train_data_num, train_data_global, test_data_global,
        train_data_local_num_dict, train_data_local_dict, test_data_local_dict, args,robust,resiliency=0,log_degree=13, log_scale=40, model_trainer=None, preprocessed_sampling_lists=None):
    if process_id == 0:
