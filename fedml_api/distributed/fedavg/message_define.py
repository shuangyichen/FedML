class MyMessage(object):
    ...
    MSG_TYPE_S2C_SK = 16
    MSG_TYPE_S2C_SEND_RECONSTRUCTION_INFO = 18
    MSG_TYPE_S2C_NEW_SK = 20
    # client to server
    ...
    MSG_TYPE_C2S_SEND_JOIN_REQUEST = 17
    MSG_TYPE_C2S_SEND_NEW_SHARE_TO_SERVER = 19
    MSG_TYPE_C2S_OFFICIAL_JOIN = 20
    # client to client
